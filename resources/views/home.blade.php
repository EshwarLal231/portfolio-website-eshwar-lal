...
@endif
    ...
    <div class="container-fluid bg-primary text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="container text-center py-5">
            ...
            <p class="m-0">&copy; <a class="text-white font-weight-bold" href="#">Eshwar lal</a>. All Rights Reserved. Designed by DEVESHWAR<a class="text-white font-weight-bold" href=""></a>
            </p>
        </div>
    </div>
    <!-- Footer End -->
